...
final ThemeData myTheme = ThemeData(
  fontFamily: 'Futura',
  primarySwatch: MaterialColor(0xff006944, {
    50: Color(0xffe5fff6),
    100: Color(0xffccffed),
    200: Color(0xff99ffdb),
    300: Color(0xff66ffc9),
    400: Color(0xff33ffb7),
    500: Color(0xff00ffa5),
    600: Color(0xff00cc84),
    700: Color(0xff009963),
    800: Color(0xff006642),
    900: Color(0xff003321)
  }),
  ...
  textTheme: TextTheme(
    ...
    subtitle1:
        TextStyle(fontSize: 16, fontWeight: FontWeight.w500, wordSpacing: 1),
    subtitle2:
        TextStyle(fontSize: 13, fontWeight: FontWeight.bold, wordSpacing: 1),
    bodyText1: TextStyle(
      color: Colors.black87,
      fontSize: 12,
  ...
  inputDecorationTheme: InputDecorationTheme(
      ...
      contentPadding:
          EdgeInsets.only(left: 10.0, top: 1.0, right: 5.0, bottom: 1.0),
