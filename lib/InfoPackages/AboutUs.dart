            ...
            children: <Widget>[
              ...
              Text(
                  "Treiner is Australia and New Zealand\'s premier soccer coaching marketplace "
                      ...
                      "you achieve your goals today.", style: TextStyle(fontSize: 16)),
              SizedBox(height: 5),
              Text(
                  "Headquartered in Melbourne, Victoria, the Treiner platform provides quality, "
                      ...
                      "more rounded soccer player no matter what position they play. " , style: TextStyle(fontSize: 16)),
              SizedBox(height: 10),
              ...
              Text(
                  "Treiner is the most convenient way to book an expert, safe and experienced "
                      ...
                      "position specific training, video analysis, and more.", style: TextStyle(fontSize: 16)),
            ],
          ),
        ),
      ),
